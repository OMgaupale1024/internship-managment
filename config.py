...
For Laragon: Default password is usually empty (''), so change line 10 to: "password": '',
"""
import os
...
DB_CONFIG = {
    ...
    "password": os.environ.get('DB_PASSWORD', '1024'),  # Change to '' for Laragon, or your MySQL password
